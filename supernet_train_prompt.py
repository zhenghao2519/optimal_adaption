...
def get_args_parser():
    ...
    # gate setting
    parser.add_argument('--add_adapter_gate',action='store_true')
    parser.add_argument('--add_lora_gate',action='store_true')
    parser.add_argument('--add_prefix_gate',action='store_true')
    parser.add_argument('--add_vpt_gate',action='store_true')
...
def main(args):
    ...
    model = models.__dict__[cfg.MODEL_NAME](   
                                                ...
                                                add_adapter_gate=args.add_adapter_gate,
                                                add_lora_gate=args.add_lora_gate,
                                                add_prefix_gate=args.add_prefix_gate,
